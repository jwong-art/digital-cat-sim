// Wardrobe function module
// Include clothes data、CatDress up SVG Etc
...
const CLOTHES_DATA = {
    tshirt: {
        ...
        price: 500,
        icon: '👕',
        description: 'Comfortable casualTT-shirt'
    },
    pajamas: {
        name: 'Pajamas',
        price: 800,
        icon: '😺',
        description: 'Cute cat pajamas'
    },
    sweater: {
        name: 'Sweater',
        price: 1500,
        icon: '🧥',
        description: 'Warm knitSweater'
    },
    dress: {
        name: 'Dress',
        price: 3000,
        icon: '👗',
        description: 'Cute pink dress'
    },
    pirate: {
        name: 'Pirate costume',
        price: 25000,
        icon: '🏴‍☠️',
        description: 'DominantPirate costume'
    },
    ninja: {
        name: 'Ninja costume',
        price: 30000,
        icon: '🥷',
        description: 'MysteriousOfNinja outfitOutfit'
    },
    superman: {
        name: 'SupermanCape',
        price: 50000,
        icon: '🦸',
        description: 'SuperheroCape'
    },
    wizard: {
        name: 'Wizard robe',
        price: 60000,
        icon: '🧙',
        description: 'MagicWizard robe'
    },
    princess: {
        name: 'Princess dress',
        price: 80000,
        icon: '👸',
        description: 'DreamyPrincess dress'
    },
    suit: {
        name: 'WesternOutfit',
        price: 10000,
        icon: '👔',
        description: 'Cool black suit'
    },
    gown: {
        name: 'Gown',
        price: 100000,
        icon: '👘',
        description: 'Gorgeous evening gown'
    },
    astronaut: {
        name: 'Astronaut suit',
        price: 150000,
